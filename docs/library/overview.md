...
If you need templates that are not currently available there are three ways to do this. All of these start by [creating your own templates](create.md). After that you can either [contribute these to the GitHub repo](contribute.md), load them [into your local database via the API]() or [set up your own repo]().
